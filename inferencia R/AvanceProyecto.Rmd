...
**Antecedentes:** El brote de COVID-19 afectó significativamente a la
industria automotriz. Con la interrupción de la cadena de suministro y
la interrupción del transporte, las nuevas incorporaciones al inventario
de automóviles usados no estaban llegando al mercado. Como resultado,
había menos modelos disponibles para la compra, lo que resultaba en
menos compras. Sin embargo, durante las últimas etapas de 2021, el
mercado comenzó a volver a la situación anterior a la pandemia,
aumentando las oportunidades para el mercado de automóviles usados con
un gran impulso de los consumidores de ingresos bajos y medios. A medio
plazo, el mercado de automóviles usados en todo el mundo está creciendo
rápidamente.
...
**Forma:** Los datos analizados se obtuvieron de la base de datos "CARS
DATASET", que fue cargada en la plataforma web "Kaggle" en el año 2020.
Esta base de datos, que sintetiza información sobre varios automóviles
usados, es una versión resumida de una base de datos más extensa que
consta de aproximadamente 10,000 registros y fue propuesta por Aishwarya
...
**Población:** La población a estudiar corresponde a los carros usados
del Reino Unido presentes en la base de datos . **Muestra:** Se usará
como muestra los carros entre los años 2015 y 2020.
...
Transmisión - Escala nominal Marca - Escala nominal Tipo de
combustible - Escala nominal
